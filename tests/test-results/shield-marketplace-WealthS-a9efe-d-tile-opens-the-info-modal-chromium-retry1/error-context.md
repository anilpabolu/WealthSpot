...
- Name: shield-marketplace.spec.ts >> WealthSpot Shield — marketplace surface >> clicking a Shield tile opens the info modal
- Location: tests\web\e2e\shield-marketplace.spec.ts:12:3
...
Locator: getByText(/7 layers between you/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/7 layers between you/i)
    ...
    - main [ref=e25]:
      - generic [ref=e31]:
        ...
        - generic [ref=e40]:
          ...
          - generic [ref=e103]:
            - button "View Builder Assessment" [active] [ref=e104] [cursor=pointer]
