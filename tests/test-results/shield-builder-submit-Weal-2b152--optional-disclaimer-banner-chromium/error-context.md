...
- Name: shield-builder-submit.spec.ts >> WealthSpot Shield — builder submit flow >> Shield step shows the optional disclaimer banner
- Location: tests\web\e2e\shield-builder-submit.spec.ts:40:3
...
Locator: getByText(/everything on this step is optional/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/everything on this step is optional/i).first()
