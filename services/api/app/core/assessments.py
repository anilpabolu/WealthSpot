    ...
    AssessmentCategory(
        ...
        sub_items=(
            AssessmentSubItem(
                ...
                prompt_for_builder="Comparable Projects Within 2 KM Radius (per Sq. ft.)",
                input_type="text",
                requires_document=True,
            ),
            AssessmentSubItem(
                ...
                prompt_for_builder="Current Market price Assessment (per Sq. ft.)",
                input_type="number",
            ),
            AssessmentSubItem(
                code="appreciation_scope",
                label="Growth Potential (per Sq. ft.)",
                prompt_for_builder="Projected 3-5 year appreciation narrative.",
                input_type="text",
            ),
            AssessmentSubItem(
                code="demand_assessment",
                label="Demand Assessment",
                prompt_for_builder="• Residential Absorption Trends\n• End-User Demand\n• Rental Potential",
                input_type="text",
            ),
        ),
    ),
    ...
    AssessmentCategory(
        ...
        sub_items=(
            ...
            AssessmentSubItem(
                code="mous",
                label="MoU",
                prompt_for_builder="MoU between builder / Land owner & Investor",
                input_type="text",
                requires_document=True,
                sensitive_document=True,
            ),
            AssessmentSubItem(
                code="capital_protection_structure",
                label="Capital Protection Structure",
                prompt_for_builder="Layered security",
                input_type="text",
                requires_document=True,
                sensitive_document=True,
            ),
