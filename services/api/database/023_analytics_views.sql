-- 023: Analytics materialized views for Vault Analytics Dashboard
-- These views pre-compute expensive aggregations for fast dashboard loads.

-- ============================================================
-- 1. Vault Summary Materialized View
-- ============================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_vault_summary_type
    ON mv_vault_summary (vault_type);


-- ============================================================
-- 2. Monthly Investment Trends Materialized View
-- ============================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_monthly_trends_month_vault
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_geo_city_state_vault
    ON mv_geographic_distribution (city, state, vault_type);


-- ============================================================
-- 4. Investor Cohort / Growth Materialized View
-- ============================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_investor_growth_month
    ON mv_investor_growth (month);


-- ============================================================
-- 5. EOI Funnel Materialized View
-- ============================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_eoi_funnel_status_vault
    ON mv_eoi_funnel (status, vault_type);


-- ============================================================
-- 6. Top Opportunities Materialized View
-- ============================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_top_opp_id
    ON mv_top_opportunities (id);


-- ============================================================
-- 7. Transaction Revenue Breakdown Materialized View
-- ============================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_txn_revenue_month_type
    ON mv_transaction_revenue (month, txn_type);


-- ============================================================
-- 8. Analytics performance indexes on source tables
-- ============================================================
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_opp_vault_status
    ON opportunities (vault_type, status);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_opp_inv_status_created
    ON opportunity_investments (status, created_at);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_inv_status_created
    ON investments (status, created_at);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_eoi_status_opid
    ON expressions_of_interest (status, opportunity_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_users_role_created
    ON users (role, created_at);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_txn_type_created
    ON transactions (type, created_at);


-- ============================================================
-- 9. Function to refresh all analytics views at once
-- ============================================================
