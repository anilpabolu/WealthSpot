...
const statusConfig: Record<string, { label: string; classes: string; icon: string }> = {
  ...
  approved: { label: 'Upcoming', classes: 'bg-blue-100 text-blue-700 dark:text-blue-300', icon: '◷' },
  pending_approval: { label: 'Upcoming', classes: 'bg-blue-100 text-blue-700 dark:text-blue-300', icon: '◷' },
  active: { label: 'Live', classes: 'bg-emerald-100 text-emerald-700 dark:text-emerald-300', icon: '●' },
  funding: { label: 'Live', classes: 'bg-emerald-100 text-emerald-700 dark:text-emerald-300', icon: '●' },
  funded: { label: 'Fully Funded', classes: 'bg-purple-100 text-purple-700 dark:text-purple-300', icon: '✓' },
  exited: { label: 'Deal Closed', classes: 'bg-theme-surface-hover text-theme-secondary', icon: '—' },
  ...
  closed: { label: 'Deal Closed', classes: 'bg-theme-surface-hover text-theme-secondary', icon: '—' },
