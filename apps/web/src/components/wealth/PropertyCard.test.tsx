...
describe('PropertyCard', () => {
  ...
  it('calls onCardClick when card clicked', () => {
    const onClick = vi.fn()
    render(<PropertyCard {...baseProps} onCardClick={onClick} />)
