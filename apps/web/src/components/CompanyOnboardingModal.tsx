  ...
  return (
    <div className="modal-overlay z-[10000]" onClick={handleClose}>
      ...
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Input label="Company Name *" required value={form.companyName} onChange={(e) => handleChange('companyName', e.target.value)} placeholder="WealthSpot Developers Pvt. Ltd." error={fieldErrors.companyName} />
                  <Input label="Brand Name" value={form.brandName ?? ''} onChange={(e) => handleChange('brandName', e.target.value)} placeholder="WS Homes" error={fieldErrors.brandName} />
                </div>
                <div>
                ...
                <Textarea label="Description" rows={2} value={form.description ?? ''} onChange={(e) => handleChange('description', e.target.value)} placeholder="Tell us about your company\u2026" error={fieldErrors.description} />
                <Input label="Website" type="url" value={form.website ?? ''} onChange={(e) => handleChange('website', e.target.value)} placeholder="https://www.yourcompany.com" error={fieldErrors.website} />
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-theme">
                ...
                <Input label={`Address Line 1${req('addressLine1')}`} value={form.addressLine1 ?? ''} onChange={(e) => handleChange('addressLine1', e.target.value)} placeholder="123 Business Park, MG Road" error={fieldErrors.addressLine1} />
                <div className="grid grid-cols-3 gap-4">
                  <Input
        ...
        {/* Toast notification — validation / API errors only */}
        {toast && (
