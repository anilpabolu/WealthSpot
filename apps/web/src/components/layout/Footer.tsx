          ...
          <div className="flex flex-col gap-5">
            <Link to="/" className="flex items-center gap-1.5 shrink-0">
              ...
              <div className="flex flex-col justify-center">
                <span
                  className="text-2xl sm:text-[28px] font-bold tracking-tight text-white leading-none"
                  style={{ fontFamily: 'Constantia, Cambria, Georgia, serif' }}
                >
                  Wealth<span className="text-[#D4AF37]">Spot</span>
                </span>
                <span className="text-[10px] sm:text-[11px] font-semibold tracking-[0.2em] text-white/70 leading-none mt-1">
