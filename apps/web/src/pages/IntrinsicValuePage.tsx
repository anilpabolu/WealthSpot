  ...
  return (
    <MainLayout>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#D4AF37]/30 bg-[#D4AF37]/10 mb-6">
              ...
              <span className="text-xs font-semibold text-[#D4AF37] uppercase tracking-wider">Investor Education White Paper</span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-white mb-4">
              Calculating <span className="text-[#D4AF37]">Intrinsic Value</span>
            </h1>
            <p className="text-lg sm:text-xl text-slate-300 leading-relaxed mb-4 max-w-2xl">
              Focus on what’s inside. Pay for what actually adds value.
            </p>
            <p className="text-sm text-slate-400 max-w-2xl">
              A practical mental model using coffee and real estate to understand intrinsic value vs market price.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <main className="flex flex-col gap-8 sm:gap-10 max-w-4xl mx-auto">
