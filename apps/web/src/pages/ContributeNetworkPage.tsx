export default function ContributeNetworkPage() {
  return (
    <div className="min-h-screen bg-theme-surface flex flex-col">
      <section className="page-hero bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="page-hero-title">Contribute Network</h1>
          <p className="page-hero-subtitle">Share your connections and help expand the WealthSpot network.</p>
        </div>
      </section>
    </div>
  )
