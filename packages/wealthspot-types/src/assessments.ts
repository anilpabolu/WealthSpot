    ...
    subItems: [
      {
        ...
        promptForBuilder: "Comparable Projects Within 2 KM Radius (per Sq. ft.)",
        inputType: "text",
        requiresDocument: true,
        sensitiveDocument: false,
      },
      {
        ...
        promptForBuilder: "Current Market price Assessment (per Sq. ft.)",
        inputType: "number",
        requiresDocument: false,
        sensitiveDocument: false,
      },
      ...
      },
      {
        ...
        promptForBuilder: "• Residential Absorption Trends\n• End-User Demand\n• Rental Potential",
        inputType: "text",
        requiresDocument: false,
        sensitiveDocument: false,
      },
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        code: "mous",
        label: "MoU",
        promptForBuilder: "MoU between builder / Land owner & Investor",
        inputType: "text",
        requiresDocument: true,
        sensitiveDocument: true,
      },
      {
        ...
        promptForBuilder: "Layered security",
        inputType: "text",
        requiresDocument: true,
        sensitiveDocument: true,
      },
