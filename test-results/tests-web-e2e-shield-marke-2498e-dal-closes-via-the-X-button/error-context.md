...
- Name: tests\web\e2e\shield-marketplace.spec.ts >> WealthSpot Shield — marketplace surface >> modal closes via the X button
- Location: tests\web\e2e\shield-marketplace.spec.ts:23:3
